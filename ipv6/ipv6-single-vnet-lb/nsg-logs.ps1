...
$rgNSG            = "ipv6-03"                 # resource group NSG-Network Security Group
$nsgName          = "nsg"                     # Name of NSG
...
$storageAccountName = "nsg-log"+ $tail

# create a storage account if it doesn't exist
$s=Get-AzStorageAccount -ResourceGroupName $rgStorage 
