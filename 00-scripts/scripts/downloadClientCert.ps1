...
Start-Process -FilePath "certutil.exe" -ArgumentList "-user","-p $local:pwdCert","-importPFX $local:fullPathCertClientFile","noRoot" -Verb RunAs -WorkingDirectory "$pathFolder$folderName" -Wait
