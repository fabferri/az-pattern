...
$armTemplate      = "azureVMSSdeploy.json"             # Name of the ARM template in your current folder
$armParams        = "azureVMSSdeploy.parameters.json"  # Name of the ARM paramenter file in your current folder
...
$parameters=@{"vmssName"=$scaleSetName;
              "vmSize"=$scaleSetVMSize;
              "instanceCount"=$scaleSetInstanceCount;
              "storageAccountType"=$storageAccountTypeScaleSet;
 ...
 #            "adminPassword"=$scaleSetVMCredentials.GetNetworkCredential().Password
              ...
              "fileServerIPAddress"=$fileSrvIPAddress;
              }
