...
## bgp_network1: first network advertised from quagga to the virtual router (inclusive of subnetmask)
## bgp_network2: second network advertised from quagga to the virtual router (inclusive of subnetmask)
## virtualrouter_IP1: first IP address of the virtual router in the virtual WAN hub
## virtualrouter_IP2: second IP address of the virtual server in the virtual WAN hub

asn_quagga=65002
bgp_routerId=10.0.2.10
bgp_network1=10.0.5.0/24
bgp_network2=10.0.6.0/24
virtualrouter_IP1=10.10.0.68
virtualrouter_IP2=10.10.0.69
...
router bgp $asn_quagga
 ...
 neighbor $virtualrouter_IP1 remote-as 65515
 neighbor $virtualrouter_IP1 soft-reconfiguration inbound
 neighbor $virtualrouter_IP2 remote-as 65515
 neighbor $virtualrouter_IP2 soft-reconfiguration inbound
!
 address-family ipv6
 exit-address-family
 exit
