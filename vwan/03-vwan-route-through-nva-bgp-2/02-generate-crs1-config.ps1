...
$pubIP_remotecsr = "csr101-pubIP"  ### Name of public IP1 assigned to the remote CSR
...
######################### remote Cisco CSR
$remoteASN='65101'                      # ASN assigned to the remote csr
$pubIP_Remotecsr=$pubIPRemotecsr        # public IP address-assigned to the remote CSR
$remotePeerBGP0='192.168.0.2'           # remote BGP peer
$remotePrivateExternalIf='10.0.101.10'  # private external interface of the CSR
...
$priv_defGtwExternal="10.0.0.1"         # CSR-default gateway of the subnet attached to the EXTERNAL NIC
$priv_internalNetw1="10.0.0.64"         # CSR-private NETWORK PREFIX assigned to the INTERNAL NIC
...
$priv_internalNetw2="10.0.0.128"        # private NETWORK PREFIX assigned to the internal subnet not direct connected to the CSR
$mask_internalNetw2="255.255.255.192"   # private MAS assigned to the internal subnet not direct connected to the CSR

$priv_internalNetw3="10.0.3.0"          # private NETWORK PREFIX assigned to the vnet in peering
...
write-host "local -address space vnet in peering........ : $priv_internalNetw3 $mask_internalNetw3" -ForegroundColor Green
