...
$pubIP_remotecsr = "csr102-pubIP"  ### Name of public IP1 assigned to the remote CSR
...
######################### remote Cisco CSR
$remoteASN='65102'                      # ASN assigned to the remote csr
$pubIP_Remotecsr=$pubIPRemotecsr        # public IP address-assigned to the remote CSR
$remotePeerBGP0='192.168.0.2'           # remote BGP peer
$remotePrivateExternalIf='10.0.102.10'  # private external interface of the CSR

######################### local Cisco CSR
$PSK=$sharedKey                         # site-to-site VPN shared secret
...
$priv_defGtwExternal="10.0.2.1"         # CSR-default gateway of the subnet attached to the EXTERNAL NIC
$priv_internalNetw1="10.0.2.64"         # CSR-private NETWORK PREFIX assigned to the INTERNAL NIC
$mask_internalNetw1="255.255.255.192"   # CSR-SUBNET MASK of private network assigned to the INTERNAL NIC
$priv_defGtwInternal="10.0.2.65"        # CSR-default gateway of the subnet attached to the INTERNAL NIC

$priv_internalNetw2="10.0.2.128"        # private NETWORK PREFIX assigned to the internal subnet not direct connected to the CSR
$mask_internalNetw2="255.255.255.192"   # private MAS assigned to the internal subnet not direct connected to the CSR

$priv_internalNetw3="10.0.4.0"          # private NETWORK PREFIX assigned to the vnet in peering
$mask_internalNetw3="255.255.255.0"     # private MASK assigned to the vnet in peering
####
