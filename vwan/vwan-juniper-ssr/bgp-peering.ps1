#  setup BGP peering in virtual hub1
#
#
# VARIABLES:
#   $inputParams: .json file with input variables
#   $armTemplateFile: ARM template file
#   $location : Azure region where depoyed the virtual hub1
#
#
################# Input parameters #################
$inputParams = 'init.json'
$armTemplateFile = 'bgp-peering.json'
$deploymentName = 'vwan-BGPpeering'
####################################################
