...
Deployment of SSR routers and conductor use BYOL; installation can be completed only by Juniper license. To get the right license, please contact a Juniper representative to ask for. Without license you won't be able to make the setup. </h1>
<br>
