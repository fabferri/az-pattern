...
$armTemplateFile= 'gettingvalues.json'
...
if (!$sharedKey) { Write-Host 'variable $sharedKey is null' ; Exit } else { Write-Host '   share secret S2S -VPN.: '$sharedKey -ForegroundColor Yellow }
