...
$pubIP_Remotecsr2  = "csr2-pubIP"  ### Name of public IP1 assigned to the remote CSR
...
$remoteASN1='65002'                      # ASN assigned to the remote csr
$pubIP_Remotecsr1=$pubIPRemotecsr2       # public IP address-assigned to the remote csr
$remotePeerBGP1='192.168.0.1'            # remote BGP peer
$remotePrivateExternalIf1='10.0.2.10'    # private external itnerface of the CSR


######################### PARAMETERS Cisco CSR
$PSK=$sharedKey                        # VPN GTW VPN site-so-site shared secret
$localASN="65102"                      # CSR-BGP ASN
...
$priv_externalNetw="10.0.102.0"        # CSR-private NETWORK PREFIX assigned to the EXTERNAL NIC
$mask_externalNetw="255.255.255.192"   # CSR-mask of private network assigned to the EXTERNAL NIC
$priv_defGtwExternal="10.0.102.1"      # CSR-IP default gateway of the subnet attached to the EXTERNAL NIC
$priv_internalNetw1="10.0.102.64"      # CSR-private NETWORK PREFIX assigned to the INTERNAL NIC
$mask_internalNetw1="255.255.255.192"  # CSR-SUBNET MASK of private network assigned to the INTERNAL NIC
$priv_defGtwInternal="10.0.102.65"

$priv_internalNetw2="10.0.102.128"     # private NETWORK PREFIX assigned to the internal subnet not direct connected to the CSR
$mask_internalNetw2="255.255.255.192"  # private MAS assigned to the internal subnet not direct connected to the CSR
#####
$fileName="csr102-config.txt"          # filename of output txt file with CSR config
