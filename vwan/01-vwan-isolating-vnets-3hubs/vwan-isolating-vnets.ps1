...
$armTemplateFile = 'vwan-isolating-vnets.json'
...
if (!$hub3location) { Write-Host 'variable $hub3location is null' ; Exit }           else { Write-Host '   hub3 location.........: '$hub3location -ForegroundColor Yellow}
