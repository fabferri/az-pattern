...
// by nuget manager include Azure.Messaging.EventHub
...
namespace read_d2c_messages
{
    ...
    {
        private static string EventHubsCompatibleEndpoint, EventHubName, IotHubSasKeyName, IotHubSasKey;
        private static void GetAppSettings()
        {
            ...
            EventHubsCompatibleEndpoint = builder.Build().GetSection("eventHubEndpoints").GetSection("EventHubsCompatibleEndpoint").Value;
            EventHubName = builder.Build().GetSection("eventHubEndpoints").GetSection("EventHubName").Value;
            IotHubSasKeyName = builder.Build().GetSection("IotHubSasKeyName").GetSection("IotHubSasKeyName").Value;
            IotHubSasKey = builder.Build().GetSection("IotHubSasKeyName").GetSection("IotHubSasKey").Value;
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine($"EventHubsCompatibleEndpoint: {EventHubsCompatibleEndpoint}");
            Console.WriteLine($"EventHubName...............: {EventHubName}");
            Console.WriteLine($"IotHubSasKeyName...........: {IotHubSasKeyName}");
            Console.WriteLine($"IotHubSasKey...............: {IotHubSasKey}");
    //        Environment.Exit(-1);
