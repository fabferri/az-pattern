...
#
################# Input parameters #################
$deploymentName = 'vpn_er'
$armTemplateFile = '01-vnets-gtws.json'
...
$parameters = @{
     ...
     "rgName_erCircuit1"        = $rgName_erCircuit1;
     "erCircuit1Name"           = $erCircuit1Name;
     "erConnection1Name"        = $erConnection1Name;
     "location1"                = $location1;
     "location2"                = $location2;
     "vNet1Name"                = $vNet1Name;
     "vNet2Name"                = $vNet2Name;
     ...
     "erGateway1Name"           = $erGateway1Name;
     "erGateway1PublicIP1Name"  = $erGateway1PublicIP1Name;
