...
$destResourceGrp1 = "RG01-VM"
$destResourceGrp2 = "RG02-VM"
...
$parametersFile1 = "$pathFiles\azuredeploy1.parameters.json"
$parametersFile2 = "$pathFiles\azuredeploy2.parameters.json"
