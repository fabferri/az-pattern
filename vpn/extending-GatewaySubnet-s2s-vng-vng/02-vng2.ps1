...
$vnet1Subnet1Name='subnet21'
$vnet1GatewaySubnetName='GatewaySubnet'
$vnet1AddressSpace='10.0.2.0/24'
$vnet1Subnet1Address='10.0.2.0/27'
$vnet1GatewaySubnetAddress='10.0.2.224/27'
...
write-host "$(Get-Date) - create vnet: $vnet1Name"
