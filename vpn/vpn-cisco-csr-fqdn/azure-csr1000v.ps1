...
$destResourceGrp1 = "RG01-NVA"   # Resource group name where will be deployed the first Cisco CSR 1000v
$destResourceGrp2 = "RG02-NVA"   # Resource group name where will be deployed the second Cisco CSR 1000v
$resourceGrpDeployment = "deploymentCSR"
##
## selection of the deployments; specify the folloiwng flag vaiables:
...
##################### Deployment in VNet 1 ######
New-AzureRmResourceGroup -Name $destResourceGrp1 -Location $location
...
##################### Deployment in VNet 2 #######
New-AzureRmResourceGroup -Name $destResourceGrp2 -Location $location
