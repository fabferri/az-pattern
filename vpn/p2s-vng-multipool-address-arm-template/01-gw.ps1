...
try {
    ...
    if (!$vpnGatewayName) { Write-Host 'variable $vpnGatewayName is null' ; Exit }         else { Write-Host '   vpnGatewayName........: '$vpnGatewayName -ForegroundColor Yellow }
...
$parameters = @{
    ...
    "vpnRootCertificatePublicKey" = $vpnRootCertificatePublicKey;
}
