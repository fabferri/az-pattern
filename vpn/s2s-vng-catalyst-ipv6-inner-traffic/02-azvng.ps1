...
#   $bgpPeeringAddress1
#   $bgpPeeringAddress2
$catalystIPAddress1Name = $catalystName + '-eth2-pip' 
$catalystIPAddress2Name = $catalystName + '-eth3-pip' 
...
<#
if ($bgpPeeringAddress1) {
     write-host "Catalyst BGP peering IP1: "$bgpPeeringAddress1 -ForegroundColor Cyan 
}
else {
     write-host "Catalyst BGP peering IP1 not found" -ForegroundColor Yellow
     Exit
}
if ($bgpPeeringAddress2) {
     write-host "Catalyst BGP peering IP2: "$bgpPeeringAddress2 -ForegroundColor Cyan 
}
else {
     write-host "Catalyst BGP peering IP2 not found" -ForegroundColor Yellow
     Exit
}
#>
