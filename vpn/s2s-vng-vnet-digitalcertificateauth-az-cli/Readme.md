# Azure Site-to-Site VPN with Digital Certificate Authentication in Az CLI
...
> [!NOTE]
> The folder **bash-script** contains the equivalent scripts in bash.
...
The pictures shows the import of leaf certificates in KeyVaults:
