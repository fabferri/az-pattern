#
# Script to deploy the ARM template 03_deploy-peer-vnets.json
# Creates hub-to-spoke VNet peerings with gateway transit
#
################# Input parameters #################
$deploymentName = 'deploy-spoke-peerings'
$armTemplateFile = '03_deploy-peer-vnets.json'
...
try {
     az deployment group create `
       ...
       --parameters spoke1=$spoke1 spoke2=$spoke2 spoke3=$spoke3 spoke4=$spoke4 spoke5=$spoke5 spoke6=$spoke6 `
       --verbose
