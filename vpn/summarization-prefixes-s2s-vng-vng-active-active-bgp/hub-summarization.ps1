#
# Script to deploy the ARM template hub-summarization.json
#
################# Input parameters #################
$deploymentName = 'hub-summarization'
$armTemplateFile = 'hub-summarization.json'
...
Write-Host (Get-Date)' - Apply the summarization' -ForegroundColor Cyan
try {
