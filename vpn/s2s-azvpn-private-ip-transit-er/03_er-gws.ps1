#
################# Input parameters #################
$deploymentName = "ergw-deployment"
$armTemplateFile = "03_er-gws.json"
$initFile = "init.txt"
####################################################
...
$parameters = @{
    ...
    "erGateway2Name"             = $erGateway2Name;
    "erSubscriptionId"           = $erSubscriptionId;
    "erResourceGroup"            = $erResourceGroup;
    "erCircuitName"              = $erCircuitName;
    "erCircuitAuthorizationKey1" = $erCircuitAuthorizationKey1;
    "erCircuitAuthorizationKey2" = $erCircuitAuthorizationKey2
}
