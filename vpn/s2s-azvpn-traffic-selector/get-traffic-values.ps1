...
$conn_11_21_Name='gtw1IP1-to-gtw2IP1'
$conn_12_22_Name='gtw1IP2-to-gtw2IP2'
$conn_11_31_Name='gtw1IP1-to-gtw3IP1'
$conn_12_32_Name='gtw1IP2-to-gtw3IP2'
...
do {
  ...
  $tmp4=''
  $i++
  $conn1 = Get-AzVirtualNetworkGatewayConnection -Name $conn_11_21_Name -ResourceGroupName $rgName
  $conn2 = Get-AzVirtualNetworkGatewayConnection -Name $conn_12_22_Name -ResourceGroupName $rgName
  $conn3 = Get-AzVirtualNetworkGatewayConnection -Name $conn_11_31_Name -ResourceGroupName $rgName
  $conn4 = Get-AzVirtualNetworkGatewayConnection -Name $conn_12_32_Name -ResourceGroupName $rgName
  ...
  $tmp1 = (" - " + "Connection vpnGw1-tunnel1-to-vnet2: $connName1, byteIngress: $ingress1, byteEgress: $egress1").ToString()
  $tmp2 = (" - " + "Connection vpnGw1-tunnel2-to-vnet2: $connName2, byteIngress: $ingress2, byteEgress: $egress2").ToString()
  $tmp3 = (" - " + "Connection vpnGw1-tunnel1-to-vnet3: $connName3, byteIngress: $ingress3, byteEgress: $egress3").ToString()
  $tmp4 = (" - " + "Connection vpnGw1-tunnel2-to-vnet2: $connName4, byteIngress: $ingress4, byteEgress: $egress4").ToString()
  $tmp5 = "---------------------------------------------------"
