...
$uri = "https://management.azure.com/subscriptions/$subscriptionId/"
$uri += "resourcegroups/$ResourceGroupName/providers/Microsoft.Network/virtualNetworks/$hub1Name/virtualNetworkPeerings/$peeringhub1Tospoke2/?syncRemoteAddressSpace=true&api-version=2023-11-01"
