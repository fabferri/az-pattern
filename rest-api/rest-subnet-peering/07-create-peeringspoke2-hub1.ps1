...
#  - create a VNet peering between spoke2 and hub1
#
...
$uri += "resourcegroups/$ResourceGroupName/providers/Microsoft.Network/virtualNetworks/$spoke2Name/virtualNetworkPeerings/$peeringspoke2Tohub1/?api-version=2023-11-01"
...
write-host "$(Get-Date) - vnet peering: $peeringspoke2Tohub1 created" -ForegroundColor Cyan

##### update subnet peering
$uri = "https://management.azure.com/subscriptions/$subscriptionID/"
$uri += "resourcegroups/$ResourceGroupName/providers/Microsoft.Network/virtualNetworks/$spoke2Name/virtualNetworkPeerings/$peeringspoke2Tohub1/?syncRemoteAddressSpace=true&api-version=2023-11-01"
