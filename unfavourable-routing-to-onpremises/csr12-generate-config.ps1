##### 
##### Script to generate the IPSec configuration of Cisco CSR2 in siteA
#####
#####
...
$csrName_Local= $json.siteA.csr2_vmName             ### Name of the local CSR
...
$csrName_Remote = $json.siteB.csr2_vmName           ### Name of the remote CSR
...
$fileName="csr12-iosxe-cfg.txt"             # filename of output txt file with CSR config
...
$privIP_csrRemote ="10.0.2.11"          # remote CSR-private ip address external interface
