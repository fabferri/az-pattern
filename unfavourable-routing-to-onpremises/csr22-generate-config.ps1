##### 
##### Script to generate the IPSec configuration of Cisco CSR2 in siteB
#####
#####
...
$csrName_Local= $json.siteB.csr2_vmName          ### Name of the local CSR
...
$csrName_Remote= $json.siteA.csr2_vmName         ### Name of the remote CSR
...
$fileName="csr22-iosxe-cfg.txt"          # filename of output txt file with CSR config
...
$privIP_csrRemote ="10.0.1.11"          # remote CSR-private ip address external interface
...
$priv_internalNextHopIP1="10.0.1.65"
#####
