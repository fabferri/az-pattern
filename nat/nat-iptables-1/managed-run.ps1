################# Input parameters #################
$deploymentName = 'test-iptables'
$armTemplateFile = 'managed-run.json'
...
if (!$nginxScriptURL) { Write-Host 'variable $nginxScriptURL is null' ; Exit }         else { Write-Host '  nginxScriptURL........: '$nginxScriptURL -ForegroundColor Yellow }
...
$parameters = @{
  "location" = $location
  "vmapp1ScriptURL"= $nginxScriptURL
}
