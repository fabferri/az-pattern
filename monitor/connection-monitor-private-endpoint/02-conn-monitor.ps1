...
#
################# Input parameters #################
$deploymentName = "conn-monitor"
$armTemplateFile = "02-conn-monitor.json"
...
if (!$workspaceName) { Write-Host 'variable $workspaceName is null' ; Exit }         else { Write-Host '   workspace name........: '$workspaceName -ForegroundColor Yellow }
