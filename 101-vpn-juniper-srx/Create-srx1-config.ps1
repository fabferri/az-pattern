...
##
######## Variables
$private_IP_Unstrusted="10.0.1.10/24"        #### private IP of the untrusted interface of srx1, inclusive of subnetmask
$private_IP_Trusted ="10.0.2.10/24"          #### private IP of the trusted interface of srx1, inclusive of subnetmask
$vtiLocal="10.0.200.1"                       #### IP address of the local VTI - WITHOUT subnetmask
...
$vtiRemote="10.0.200.2"                      #### IP address of the remote VTI interface
$localASN="65001"                            #### BGP local ASN
$remoteASN="65002"                           #### BGP remote ASN
$SharedSecret="Password123!"                 #### shared secret IKE
$gtw_IP_internet="10.0.1.1"                  #### IP address of the gateway subnet of the untrusted interface srx1
...
$fileName="config-srx1.txt"                  #### name of the text file to store the configuration of srx1
################################ 
...
$publicIPUntrustedLocal =$pubIP_srx1
$publicIPUntrustedRemote =$pubIP_srx2
