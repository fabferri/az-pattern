...
$priv_externalNetw="10.101.1.0"          # CSR-private NETWORK PREFIX assigned to the EXTERNAL NIC
$mask_externalNetw="255.255.255.0"     # CSR-mask of private network assigned to the EXTERNAL NIC
$priv_defGtwExternal="10.101.1.1"        # CSR-default gateway of the subnet attached to the EXTERNAL NIC
$priv_internalNetw1="10.101.2.0"         # CSR-private NETWORK PREFIX assigned to the INTERNAL NIC
$mask_internalNetw1="255.255.255.0"    # CSR-SUBNET MASK of private network assigned to the INTERNAL NIC
$priv_defGtwInternal="10.101.2.1"        # CSR-default gateway of the subnet attached to the INTERNAL NIC

$priv_internalNetw2="10.101.3.0"         # private NETWORK PREFIX assigned to the internal subnet not direct connected to the CSR
