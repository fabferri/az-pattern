...
$rgLocal=$json.siteB.rgName
$rgRemote=$json.siteA.rgName
$nicNameLocal=$json.siteB.srx1_vmName+'-ge-0-0-0'
$nicNameRemote=$json.siteA.srx1_vmName+'-ge-0-0-0'

Try {
  $ip_srx_Local=(Get-AzPublicIpAddress  -ResourceGroupName $rgLocal -Name $nicNameLocal -ErrorAction Stop).IpAddress }
catch {
 Write-Host (Get-Date)' - ' -NoNewline
 Write-Host (Get-Date)'Error getting the public IP' -NoNewline
 Exit
}
...
$tunnelLocalIP="192.168.1.2"
$tunnelLocalMask="/30"
$tunnelRemoteIP="192.168.1.1"
$loopbackLocalIP="172.16.1.2"
$loopbackLocalMask="/32"
$loopbackRemoteIP= "172.16.1.1"
$greLocalIP="172.16.255.2"
$greLocalMask="/30"
$vpnGtwLocalPubIP=$ip_srx_Local
$vpnGtwRemotePubIP=$ip_srx_Remote
$srx_untrustedInterface_privIP="10.0.2.33"
$presharedKey= "Mysharedpwd*01"

$fileName="srx2-config.txt"
...
set routing-options static route 0.0.0.0/0 next-hop 10.0.2.33
