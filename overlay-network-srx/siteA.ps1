...
$subscriptionName = $json.siteA.subscriptionName
$rgName  = $json.siteA.rgName
$location = $json.siteA.location
$armTemplateFile  = 'siteA.json'
$resourceGrpDeployment = 'siteA-deployment'
...
$parameters=@{
              ...
              "location"=$json.siteA.location;
              "vsrx-name"=$json.siteA.srx1_vmName
              }
