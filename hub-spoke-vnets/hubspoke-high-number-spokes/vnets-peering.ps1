...
$armTemplateFile = 'vnets-peering.json'
#
####################################################
...
Write-Host 'Variables featched from the init.txt file:' -ForegroundColor Cyan
Write-Host $rgName -ForegroundColor Cyan
write-host $RGTagExpireDate -ForegroundColor Cyan
write-host $RGTagContact -ForegroundColor Cyan
write-host $RGTagNinja -ForegroundColor Cyan
write-host $RGTagUsage -ForegroundColor Cyan
write-host ''
