...
$armTemplateFile = 'vm-sshkey.json'
...
try {
    ...
    $adminPublicKey = $arrayParams.adminPublicKey
    ...
    if (!$adminPublicKey) { Write-Host 'variable $adminPublicKey is null' ; Exit }         else { Write-Host '   admin adminPublicKey..: '$adminPublicKey -ForegroundColor Green }
} 
catch {
