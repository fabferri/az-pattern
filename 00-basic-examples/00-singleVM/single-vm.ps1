...
#
#   $adminUsername    : administrator username. please replace ADMINISTRATOR_USER with your username before running the script!!
#   $adminPassword    : adminsitrator password. please replace ADMINISTRATOR_PASSWORD with your password before running the script!!
...
param (
    ...
    [string]$adminUsername = "ADMINISTRATOR_USER",
...
################# Input parameters #################
$subscriptionName = "AzDemo" 
$location         = "eastus"
$rgName           = "vm-dev001"
$deploymentName   = "single-vm"
