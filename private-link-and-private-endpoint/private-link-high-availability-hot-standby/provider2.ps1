################# Input parameters #################
$deploymentName = 'provider2'
$armTemplateFile = 'provider2.json'
...
$parameters = @{
    "location"      = $provider2Location;
    "adminUsername" = $adminUsername;
    "adminPassword" = $adminPassword
}

$subscriptionName= $provider2SubscriptionName
$rgName = $provider2ResourceGroupName
$location = $provider2Location
