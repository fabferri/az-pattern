################# Input parameters #################
$deploymentName = 'provider1'
$armTemplateFile = 'provider1.json'
...
$parameters = @{
    "location"      = $provider1Location;
    "adminUsername" = $adminUsername;
    "adminPassword" = $adminPassword
}

$subscriptionName= $provider1SubscriptionName
$rgName = $provider1ResourceGroupName
$location = $provider1Location
