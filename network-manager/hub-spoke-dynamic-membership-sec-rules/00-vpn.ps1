...
#
################# Input parameters #################
$deploymentName = "vpn00"
$armTemplateFile = "00-vpn.json"
...
if (!$locationbranch) { Write-Host 'variable $locationbranch is null' ; Exit }       else { Write-Host '   locationbranch.............: '$locationbranch -ForegroundColor Yellow }
