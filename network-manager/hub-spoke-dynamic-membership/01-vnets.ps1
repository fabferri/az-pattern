...
Try {
    ...
    Write-Host '  resource exists, skipping'
    Set-AzResourceGroup -Name $resourceGroupNameVNet1 -Tag @{Environment = "PROD" } 
}
Catch {
...
Try {
    ...
    Write-Host '  resource exists, skipping'
    Set-AzResourceGroup -Name $resourceGroupNameVNet2 -Tag @{Environment = "PROD" } 
}
Catch {
...
Try {
    ...
    Write-Host '  resource exists, skipping'
    Set-AzResourceGroup -Name $resourceGroupNameVNet3 -Tag @{Environment = "TEST" } 
}
Catch {
...
Try {
    ...
    Write-Host '  resource exists, skipping'
    Set-AzResourceGroup -Name $resourceGroupNameVNet4 -Tag @{Environment = "TEST" } 
}
Catch {
