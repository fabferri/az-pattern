# Before running the script customize the values of the variables in the init.json file
#
################# Input parameters #################
$deploymentName = "anm1"
...
if (!$locationhub0) { Write-Host 'variable $locationhub0 is null' ; Exit }           else { Write-Host '   locationhub0..........: '$locationhub0 -ForegroundColor Yellow }
...
$parameters = @{ 
     "resourceGroupNameHub0VNet" = $ResourceGroupName;
     "resourceGroupNameHub1VNet" = $ResourceGroupName;
     "resourceGroupNameHub2VNet" = $ResourceGroupName;
