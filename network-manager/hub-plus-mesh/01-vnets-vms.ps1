# Before running the script set the variables in the init.json file
#
################# Input parameters #################
...
$parameters = @{ 
    "mngIP"           = $mngIP;
    "locationhubvnet" = $locationhubvnet;
    "locationvnet1"   = $locationvnet1;
    "locationvnet2"   = $locationvnet2;
    "locationvnet3"   = $locationvnet3;
    "locationvnet4"   = $locationvnet4;
    "locationvnet5"   = $locationvnet5;
    "locationvnet6"   = $locationvnet6;
    "locationvnet7"   = $locationvnet7;
    "locationvnet8"   = $locationvnet8;
    "locationvnet9"   = $locationvnet9;
    "locationvnet10"  = $locationvnet10;
