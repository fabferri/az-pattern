# ARM template action: 
#  - create the frontend, with backend to the public IPs of the application Gateways in spoke1 and spoke3
#
...
################ INPUT VARIABLES ###################
$deploymentName = 'frontdoorDeployment'
$armTemplateFile = '09-frontdoor.json'
