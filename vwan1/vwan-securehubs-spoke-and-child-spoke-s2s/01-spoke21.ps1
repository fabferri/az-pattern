...
#   $rgWanName: resource group name for virtual WAN resources (validation only)
#   $rgSpoke21: resource group name for spoke21 deployment
...
#   $majorPrivNetwork: major private network address space (for routing)
